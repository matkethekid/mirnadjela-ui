    ...
    <div className="w-full min-h-screen flex flex-col items-center mx-auto">
      ...
      <main className="w-full h-[70vh] relative bg-[#001233] flex items-center">
        ...
        <div className="z-30 flex flex-col gap-1 w-full relative max-w-7xl mx-auto p-5 lg:p-10 2xl:p-0">
          <Image src={"/angel.svg"} width={30} height={30} alt="angel logo" className="w-20 h-20 lg:w-30 lg:h-30"/>
          <div>
            <p className="text-[#D4AF37]">MIR ANĐELA</p>
            <div className="bg-[#D4AF37] w-40 h-px mt-2 mb-2"></div>
          ...
          <Link href={"/kontakt"} className="pt-3 pb-3 pl-7 pr-7 bg-[#D4AF37] mt-10 max-w-[250px] text-[#002366] text-center rounded-[4px]">KONTAKTIRAJTE NAS</Link>
        </div>
      </main>
    </div>
  );
