            ...
            <main className="w-full flex flex-col flex-1 bg-[#001233] pt-5 pb-5 pl-7 pr-7 lg:pl-25 lg:pr-25">
                <div className="flex flex-col gap-5">
                    <h1 className={`${notoSerif.className} text-white text-5xl lg:text-6xl max-w-175 lg:leading-18`}>
                        Administrativna pomoć nakon smrti – podrška porodici
                    </h1>
                    <p className="text-[#C5C6D2] max-w-175">
                        Mir Anđela pruža administrativnu pomoć porodicama nakon smrti
                        člana porodice, kako bi se smanjio dodatni teret oko
                        dokumentacije i potrebnih procedura. Pomažemo vam da se
                        informišete o potrebnim dokumentima, smrtovnici, izvodima iz
                        matičnih knjiga, prijavama, odjavama i drugim administrativnim
                        postupcima koji mogu biti potrebni nakon smrti. Pružamo i
                        podršku u vezi sa dokumentacijom za PIO fond i ostvarivanjem
                        prava na naknadu pogrebnih troškova. Naš cilj je da porodica
                        dobije jasne informacije i pomoć u organizaciji svih
